    ...
    <div class="mainmenu-wrapper">
        <div class="container">
            ...
            <nav id="mainmenu" class="mainmenu">
                <ul>
                    <li class="logo-wrapper"><a href="index.html"><img src="../../assets/image/mPurpose-logo.png" alt="Multipurpose Twitter Bootstrap Template"></a></li>
                    <li>
...
<style>
    @import "../../assets/css/header/main.css";
</style>